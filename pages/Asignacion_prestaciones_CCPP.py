    ...
    if submitted:
        if not nombre or not email or not asunto or not mensaje:
            ...
            with st.spinner("📤 Enviando mensaje..."):
                success, msg = enviar_correo(nombre, email, asunto, mensaje, institucion, cargo, "Asignación automática de prestaciones CCPP")
                ...
                """
                correo_simple(
                    asunto="Enlace de referencia - Asignación automática de prestaciones CCPP",
