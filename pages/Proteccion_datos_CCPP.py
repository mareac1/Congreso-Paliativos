...
st.set_page_config(
    page_title="Aplicación de la Ley N° 21.719 en registros de Cuidados Paliativos",
    page_icon="🔒",
    layout="wide",
...
<div class="main-header">
    <h1>🔒 Aplicación de la Ley N° 21.719 de Protección de Datos Personales</h1>
    <h3>en registros de Cuidados Paliativos</h3>
</div>
...
if seccion == "📋 Resumen de la Investigación":
    ...
    with col1:
        st.markdown("""
        #### 🔍 Introducción
        La reciente **Ley N° 21.719 de Protección de Datos Personales (2024)** impone 
        estándares más estrictos para el tratamiento de datos sensibles, especialmente 
        en el ámbito sanitario.  
        
        Este proyecto describe la implementación de un **sistema integral de gestión de datos** 
        en un programa de atención domiciliaria para personas en cuidados paliativos, 
        orientado a cumplir la nueva regulación sin interferir en la atención clínica 
        ni en la toma de decisiones terapéuticas.
        """)
    with col2:
        st.markdown("""
        <div style="background: linear-gradient(135deg, #36d1dc, #5b86e5);
            ...
            <h3>📊 Datos Clave</h3>
            <h2>3</h2>
            <p>Meses de implementación técnica</p>
            <h2>100%</h2>
            <p>Flujos clínicos auditados</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    if submitted:
        if not nombre or not email or not asunto or not mensaje:
            ...
            with st.spinner("📤 Enviando mensaje..."):
                success, msg = enviar_correo(nombre, email, asunto, mensaje, institucion, cargo, "Protección de Datos CCPP")
                ...
                """
                correo_simple(
                    asunto="Enlace de referencia - Protección de Datos CCPP",
